...
- **purge** — Delete the entire stored project directory (patterns, database, and all data) for the current project
- **purge --all** — Delete all stored project directories across all projects (requires `--yes`)
