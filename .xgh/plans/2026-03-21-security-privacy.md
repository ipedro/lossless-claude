...
Case-insensitive: JavaScript RegExp does not support inline flags like \`(?i)\`. Encode case variants explicitly using character classes, e.g. \`[Mm][Yy]_[Tt][Oo][Kk][Ee][Nn]\`.
