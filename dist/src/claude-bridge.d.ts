...
export interface ClaudePluginApi {
    ...
    runtime: {
        ...
        modelAuth?: {
            getApiKeyForModel: (params: Record<string, unknown>) => Promise<{
                apiKey?: string;
            } | undefined>;
            resolveApiKeyForProvider: (params: Record<string, unknown>) => Promise<{
                apiKey?: string;
            } | undefined>;
        };
        [key: string]: unknown;
    ...
    registerTool(factory: (ctx: {
        sessionKey: string;
    }) => AnyAgentTool, options?: {
        name?: string;
    }): void;
